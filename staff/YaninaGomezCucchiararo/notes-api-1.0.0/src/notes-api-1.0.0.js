    ...
    unregisterUser(id, email, password) {
        return Promise.resolve()
            .then(() => {
                ...
                return axios.delete(`${this.url}/users/${id}`, {data : {email, password}}) // id= id de usuario de la BD q lo crea automaticamente mongo + los datos que nos envian por formulario por el body
                //.then(({ data: { data: user } }) => user)
                // console.log(id)
                .then(({ status, data }) => {
    ...
    addNote(userId, text) {
        return Promise.resolve()
            .then(() => {
                ...
                return axios.post(`${this.url}/users/${userId}/notes`, {text: text})
                    .then(({status, data})=> {
